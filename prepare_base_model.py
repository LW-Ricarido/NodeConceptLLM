...
base_model.save_pretrained('base_model/{}_resized_embedding'.format(original_model_name.split('/')[1]))
base_tokenizer.save_pretrained('base_model/{}_resized_embedding'.format(original_model_name.split('/')[1]))